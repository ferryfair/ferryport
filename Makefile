...
# Add your post 'clean' code here...
	rm ${CND_ARTIFACT_DIR_${CONF}}/config.xml
	rm ${CND_ARTIFACT_DIR_${CONF}}/error.log
	rm ${CND_ARTIFACT_DIR_${CONF}}/init.conf
	rm ${CND_ARTIFACT_DIR_${CONF}}/init.d
	rm ${CND_ARTIFACT_DIR_${CONF}}/devices.rules
	rm ${CND_ARTIFACT_NAME_${CONF}}
# clobber
